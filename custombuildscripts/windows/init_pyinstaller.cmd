...
set SNAPSHOTDIR=c:\media\snapshots
set SECRETSDIR=c:\media\secrets
...
call :ECHO "Run custom script to copy sources"
call "c:\media\Master\custombuildscripts\windows\copy_sources.cmd"
...
rem call :PIP_INSTALL --upgrade "setuptools==40.6.2"
call :PIP_INSTALL --upgrade "setuptools==51.1.1"
rem Install Kivy Dependencies Upgrade virtualenv Version 16.7.8
rem call :PIP_INSTALL --upgrade "virtualenv==16.7.8"
call :PIP_INSTALL --upgrade "virtualenv==20.2.2"
rem Install Kivy Dependencies docutils Version 0.15.2
rem call :PIP_INSTALL "docutils==0.15.2"
call :PIP_INSTALL "docutils==0.16"
rem Install Kivy Dependencies pygments Version 2.5.2
rem call :PIP_INSTALL "pygments==2.5.2"
call :PIP_INSTALL "pygments==2.7.3"

rem Install Kivy Dependencies pypiwin32 Version 223
call :PIP_INSTALL "pypiwin32==223"
rem call :PIP_INSTALL "pywin32==227"
call :PIP_INSTALL "pywin32==300"
rem Install Kivy Dependencies kivy_deps.sdl2 Version 0.1.22
rem call :PIP_INSTALL "kivy_deps.sdl2==0.1.22"
call :PIP_INSTALL "kivy_deps.sdl2==0.3.1"
rem Install Kivy Dependencies kivy_deps.glew
call :PIP_INSTALL "docutils"
rem call :PIP_INSTALL "kivy_deps.glew==0.1.12"
call :PIP_INSTALL "kivy_deps.glew==0.3.0"

rem Install Kivy Dependencies kivy_deps.angle
rem call :PIP_INSTALL "kivy_deps.angle==0.1.9"
call :PIP_INSTALL "kivy_deps.angle==0.3.0"
rem verify if we need this
rem Install ffpyplayer Version 4.3.0
rem call :PIP_INSTALL "ffpyplayer==4.3.0"
call :PIP_INSTALL "ffpyplayer==4.3.2"
rem Install GStreamer Version 0.1.17
rem call :PIP_INSTALL "kivy_deps.gstreamer==0.1.17"
call :PIP_INSTALL "kivy_deps.gstreamer==0.3.1"
rem Install Kivy Version 1.11.0
call :PIP_INSTALL "kivy==2.0.0"
rem Install OpenCv (for testing)
pip3 install opencv-python >> %LOGFILE%
rem Install pyinstaller Version 3.5
call :PIP_INSTALL "pyinstaller==4.1"
...
rem pip install %~1 %~2 %~3 >>%LOGFILE%
python -m pip install %~1 %~2 %~3 >>%LOGFILE%
