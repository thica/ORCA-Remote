...
if [[ $varTARGET == ANDROID ]]; then
	...
	cp "${varWORKDIRBD}"/.buildozer/android/platform/python-for-android/orca-${varORCAVERSION}-release.apk ${varDESTDIR}/Deployment/${varAPPNAME4}-${varORCABRANCH}-${varORCAVERSION}.apk
