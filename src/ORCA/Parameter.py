...
class cParserAction(argparse.Action):
    def __init__(self, option_strings,  oParameter, *args, **kwargs):
        self.oParameter = oParameter
...
class cParameter(QueryDict):
    def __init__(self):
        ...
        oParser = argparse.ArgumentParser(description='ORCA Open Remote Control Application')
    ...
    def RemoveOtherArguments(self,oParser):
        aRet = []
