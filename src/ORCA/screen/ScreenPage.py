...
class cScreenPage:
    ...
    def __init__(self):
        ...
        self.uHexBackGroundColor:str                           = '#000000'
        self.uPageName:str                                     = 'NoName'
        ...
        self.uDefaultInterface:str                             = ''
        self.uDefaultConfigName:str                            = ''
        self.dFktsCreateWidget:Dict[eWidgetType,Tuple[Callable,Any]]   = {}
        self.bIsPopUp:bool                                     = False
        self.bPreventPreInit:bool                              = False
        self.uCallingPageName:str                              = ''
        self.uCalledByPageName:str                             = ''

        #not used
        self.uOrientation:str                                  = ''
    ...
    def InitPageFromXmlNode(self,*,oXMLNode:Element) -> None:
        ...
        self.uPageName          = GetXMLTextAttribute(oXMLNode=oXMLNode,uTag='name',bMandatory=True,vDefault='')
        oRef:Element            = oXMLNode.find('page_parameter')
        self.uDefaultInterface  = GetXMLTextValue(oXMLNode=oRef,uTag='interface',      bMandatory=False,vDefault='')
        self.uDefaultConfigName = GetXMLTextValue(oXMLNode=oRef,uTag='configname',     bMandatory=False,vDefault='')
        self.bIsPopUp           = GetXMLBoolValue(oXMLNode=oRef,uTag='popup',          bMandatory=False,bDefault=False)
        self.bPreventPreInit    = GetXMLBoolValue(oXMLNode=oRef,uTag='preventpreinit', bMandatory=False,bDefault=False)
        ...
        #not used
        self.uOrientation       = GetXMLTextValue(oXMLNode=oRef,uTag='orientation',bMandatory=False,vDefault=Globals.uDeviceOrientation)

        if not self.uDefaultInterface=='':
    ...
    def AddPageElementsFromXmlNode(self,*,oXMLNode:Element) -> None:
        ...
        self._AddElements(oXMLNode=oXMLNode, uAnchor='')
    ...
    def LoadElement(self,*,uFnElement:str, uAnchor:str, oDefinition:cDefinition) -> bool:
        ...
        try:
            oFnElement=cFileName(uFnElement)
            SetVar(uVarName = 'ORCA_INCLUDEFILE', oVarValue = str(oFnElement))
            ...
            oET_Root = Orca_FromString(uET_Data=uET_Data,oDef=oDef,uFileName=str(oFnElement))
            ...
            ShowErrorPopUp(uMessage=LogError(uMsg=f'Can\'t load element: {uFnElement}:', oException=e))
            return False
    ...
    def ReplaceElement(self,*,uFnElement:str, uReplaceWidgetName:str,oDefinition:cDefinition) -> bool:
        ...
        try:
            uFnFile=str(cFileName(uFnElement))
            ...
            ShowErrorPopUp(uMessage=LogError(uMsg=f'Can\'t load element (replace): {uFnElement} ({uFnFile}):', oException=e))
            return False
    ...
    def _AddElements(self,*,oXMLNode:Element, uAnchor:str) -> Union[cWidgetBase,None]:
        ...
        if self.oWidgetBackGround.uName=='noname':
    ...
    def AddWidgetFromXmlNode_BackGround(self,*, oXMLNode:Element, uAnchor:str, oClass:Callable) -> cWidgetBase:
        return self._AddElements(oXMLNode=oXMLNode, uAnchor='')

    # noinspection PyMethodMayBeStatic,PyUnusedLocal
    def AddWidgetFromXmlNode_None(self,*, oXMLNode:Element, uAnchor:str, oClass:Callable)  -> cWidgetBase:
        ShowErrorPopUp(uMessage=LogError(uMsg='AddWidget: Invalid Widget:'+str(tostring(oXMLNode))))
        return cWidgetBase()
    ...
    def AddWidgetFromXmlNode(self,*,oXMLNode:Element, uAnchor:str) -> Union[bool,cWidgetBase]:
        ...
        if oTmpWidget.eWidgetType != eWidgetType.ERROR:
            ...
            if Ret is None:
                Logger.error(f'Unknown widget type {oTmpWidget.uTypeString} : Page: {self.uPageName}')
                return False
        return False
    ...
    def Create(self) -> None:
        ...
        try:
            ...
            Logger.debug (f'ScreenPage: creating page: {self.uPageName} width:{Globals.iAppWidth} , height:{Globals.iAppHeight}')
            ...
            ShowErrorPopUp(uMessage=LogError(uMsg=f'ScreenPage: can\'t create page [{self.uPageName}]:', oException=e))
    ...
    def UpdateSetupWidgets(self) -> None:
        ...
        #Its safe to call create again, in case, it didn't happen by now
        self.Create()
        oWidget:cWidgetBase
        for oWidget in self.dWidgetsID.values():
    ...
    def OnKey(self,window,uKey:str) -> bool:
        ...
        # Logger.debug ('ScreenPage: KeyPressed: '+uKey)
