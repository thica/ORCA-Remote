...
class cBaseObject:
    ...
    def __init__(self):
        ...
        self.uIniFileLocation:str               = 'local'
        self.uObjectName:str                    = ''
        self.uObjectType:str                    = ''
    ...
    def _FormatShowMessage(self,*,uMsg:str,uParConfigName:str='',uParAdd:str='') -> str:
        """
        ...
        uConfigName:str = ''
        if uParConfigName:
            uConfigName = '/' + uParConfigName
        if uParAdd!='':
            uConfigName = uConfigName+'/' + uConfigName

        return '%s %s%s: %s' % (self.uObjectType.capitalize(),self.uObjectName , uConfigName , uMsg)

    def ShowWarning(self,*,uMsg:str,uParConfigName:str='') -> str:
        """
    ...
    def ShowDebug(self,*,uMsg:str,uParConfigName:str='') -> str:
        """
    ...
    def ShowInfo(self,*,uMsg:str,uParConfigName:str='') -> str:
        """
    ...
    def ShowError(self,*,uMsg:str, uParConfigName:str='',uParAdd:str='',oException:Exception=None) -> str:
        """
...
class cBaseObjects:
    ...
    def CreateJsonSectionList(self,*,aObjectList:List[str]) -> str:
        ...
        if uRetJson.endswith(','):
            ...
            uRetJson=uRetJson+"]"
        SetVar(uVarName=self.uPrefix+'_'+'SETTINGSECTIONLIST', oVarValue=uRetJson)
        return uRetJson
