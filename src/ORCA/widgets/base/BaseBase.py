...
class cWidgetBaseBase:
    def __init__(self,**kwargs):
        ...
        self.uAnchorName: str                          = ''
        self.uConfigName:str                           = ''  # as we can use most widgets as Anchors, we need to have interface and config generic
        self.uFileName:str                             = ''
        self.uFileNames:str                            = ''
        self.uID                                       = str(uuid.uuid4())
        self.uInterFace:str                            = ''  # as we can use most widgets as Anchors, we need to have interface and config generic
        self.uLastWidgetID                             = ''
        self.uName:str                                 = 'noname'
