...
class cInterface(cBaseInterFace):
    ...
    class cInterFaceSettings(cBaseInterFaceSettings):
        ...
        def __init__(self,oInterFace:cInterface):
            ...
            self.aIniSettings.uPort                       = '5555'
            self.aIniSettings.uFNCodeset                  = 'CODESET_android_adb_DEFAULT.xml'
            ...
            if TYPE_CHECKING:
                ...
                oFn_Adb_Helper = cFileName(self.oInterFace.oPathMyCode) + 'adb_helper.py'
        ...
        def Connect(self) -> bool:
            ...
            try:
                ...
                if hasattr(e,"errno"):
                    ...
                    if e.errno==10051:
                        self.bOnError=True
                        self.ShowWarning(uMsg='Can\'t connect (No Network):'+self.aIniSettings.uHost+':'+self.aIniSettings.uPort)
                        return False
    ...
    def SendCommand(self,oAction:cAction,oSetting:cInterFaceSettings,uRetVar:str,bNoLogOut:bool=False) -> eReturnCode:
        ...
        while iTryCount<oSetting.aIniSettings.iRetryCount:
            ...
            if oSetting.bIsConnected:
                try:
                    self.ShowDebug(uMsg=f'Sending adb command: {oAction.uCmd}:{uParams}')
                    ...
                    self.ShowDebug(uMsg='Parsed Response:'+uRetVal)
                    if not uRetVar=='':
